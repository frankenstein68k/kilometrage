...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="genCenBox">
        <h3>Welcome to Kilometrage - the mileage and fuel tracking website</h3>
        ...
        <p>
            By figuring out what your fuel tank capacity you are setting an limit on the amount of fuel your car can take. 
        ...
        you can figure subtract fuel added from the tank capacity to get the amount of fuel used.
        </p>
